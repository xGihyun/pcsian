import { c as create_ssr_component, a as add_attribute, v as validate_component, e as each, b as escape } from "../../chunks/index3.js";
import "../../chunks/animations.js";
const kessokuBand = "/_app/immutable/assets/KessokuBand.c8bcb5c3.webp";
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<section class="${"relative h-screen"}"><span class="${"from-nav-gradient absolute bottom-0 left-0 z-20 h-20 w-full bg-gradient-to-t"}"></span>
	<video${add_attribute("src", video, 0)} autoplay loop muted class="${"absolute bottom-0 left-0 -z-10 h-screen w-full object-cover brightness-[30%]"}"></video>
	<div class="${"h-full"}"><div class="${"flex h-full flex-col items-center justify-center text-center text-white [&>p]:pointer-events-none [&>h1]:pointer-events-none"}"><h1 class="${"mb-10 text-5xl lg:text-7xl"}">Quality Catholic Education</h1>
...
const Programs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"py-60"}"><div class="${"relative flex h-full flex-col items-center justify-between gap-20 px-[10%] pb-40 lg:flex-row"}"><div class="${"flex w-full flex-col text-center text-white lg:max-w-[50%] lg:text-left"}"><h2${add_attribute(
    "class",
    ...
    0
		...
		<div class="${"relative hidden h-full w-full items-center justify-center lg:flex"}">${validate_component(OrangeBlob1, "OrangeBlob1").$$render($$result, {}, {}, {})}
			<a href="${"https://www.deviantart.com/haerge/art/Kessoku-Band-Bocchi-The-Rock-936713092"}" rel="${"noreferrer"}" target="${"_blank"}"><img${add_attribute("src", kessokuBand, 0)} alt="${""}" class="${"float-shadow z-10 w-full max-w-xl"}"></a></div></div>
	<div class="${"flex w-full flex-col items-center justify-center gap-10 px-[10%] lg:flex-row"}">${each(programs, (program, idx) => {
...
<div class="${"relative h-full bg-white px-[10%] py-40"}"><div${add_attribute(
    "class",
