...
<div class="relative flex w-full bg-white px-[10%] py-20 text-black lg:px-[20%] lg:py-32">
	<div class="flex flex-col justify-center ">
		<h2
			class={`font-gt-walsheim-pro-medium transform-gpu text-start text-3xl transition-all duration-1000 ease-in-out md:text-center md:text-5xl ${
				isInView[0]
		...
		/>
		<p
			class={`transform-gpu text-base transition-all delay-700 duration-1000 ease-in-out md:text-center md:text-2xl ${
				isInView[0]
					? 'md:translate-y-0 md:opacity-100 md:blur-0'
					: 'md:translate-y-full md:opacity-0 md:blur-[2px]'
			}`}
...
<div class="relative h-full bg-white px-[10%] py-20 lg:py-32">
	<img
		src={pcsAnnex}
		alt="pcs annex"
		class="transition-transform-opacity-filter absolute bottom-0 right-0 max-w-sm opacity-20 saturate-0 duration-300 lg:hover:opacity-75 lg:hover:saturate-100 sm:right-[10%] md:max-w-lg lg:max-w-none"
	/>
	<div
	...
	>
		<div class="flex flex-col">
			<div
				class={`relative flex transform-gpu flex-col whitespace-nowrap transition-all duration-1000 ease-in-out  ${
					isInView[1]
						? 'md:translate-y-0 md:opacity-100 md:blur-0'
						: 'md:translate-y-full md:opacity-0 md:blur-[2px]'
				}`}
			...
			/>
			<h2
				class={`font-gt-walsheim-pro-medium mb-8 text-3xl transition-all duration-1000 ease-in-out md:text-5xl ${
					isInView[1]
						? 'md:translate-y-0 md:opacity-100 md:blur-0'
						: 'md:translate-y-full md:opacity-0 md:blur-[2px]'
				}`}
			...
			<div>
				<div class="relative pl-3 sm:pl-6">
					<span
						class={`bg-accent absolute inset-y-0 left-0 w-1 origin-top rounded-full transition-transform delay-700 duration-1000 sm:w-2 ${
							isInView[1] ? 'md:scale-y-100' : 'md:scale-y-0'
						}`}
					/>
					<p
				...
				<div class="flex gap-4">
					<a
						class="hover:bg-accent z-30 rounded-full bg-black py-2 px-4 text-sm text-white transition-all duration-300 hover:scale-90 md:py-3 md:px-5 md:text-xl"
					...
					>
					<a
						class="z-30 rounded-full border-[1px] border-black py-2 px-4 text-sm text-black transition-all duration-300 hover:scale-90 md:py-3 md:px-5 md:text-xl"
