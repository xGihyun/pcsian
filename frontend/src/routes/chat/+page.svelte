...
<div class="shadow-custom-1 relative h-full w-full max-w-7xl">
	<div class="relative h-full w-full max-w-7xl overflow-y-scroll px-[5%]">
		<div class="flex flex-col items-center justify-center pt-32 pb-10 sm:pt-40 sm:pb-20">
			<div class="mb-10 flex flex-col items-center justify-center">
				...
				<h1 class="font-gt-walsheim-pro-medium text-center text-2xl text-black sm:text-4xl mb-2">
				...
				{#each initialQuestions as question, idx (idx)}
					<div class="flex-1 w-full">
						<div class="flex flex-col gap-2">
							...
							<button
								class="hover:shadow-chat-msg border-accent text-accent h-full rounded-2xl border-[1px] px-4 py-2 text-sm sm:text-base transition-[box-shadow,filter] duration-300 hover:brightness-90 sm:py-4"
								on:click={() => {
	...
	<div class="fixed w-full max-w-7xl">
...
<style>
	:root {
		...
		--scrollbar-thumb-light: rgb(175, 175, 175);
	}
