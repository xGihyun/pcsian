...
<section class="relative h-screen">
	<span class="from-nav-gradient absolute bottom-0 left-0 z-20 h-40 w-full bg-gradient-to-t" />
	<video
		src={video}
		autoPlay
		loop
	...
	<div class="h-full px-[5%] pb-20">
		...
		>
			<h1 class="mb-10 w-4/5 md:w-2/3 text-start text-4xl font-gt-walsheim-pro-medium md:text-5xl lg:w-1/2 lg:text-6xl">
